...
FebftMonitor::FebftMonitor(CephContext *cct_, std::string nm, MonitorDBStore *store, Messenger *m, Messenger *mgr_m,
    ...
    febft = std::make_unique<FebftSMR>(*this, "febft", this->name);
...
int FebftMonitor::mkfs(ceph::buffer::list &osdmapbl) {

    auto t = this->febft->get_pending_transaction();
